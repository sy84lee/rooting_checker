...
public class detect_module_4_test {
    static {
        System.loadLibrary("detectEngine");
    }

    @Test
    public void run_detect_Exist_Xpose_Files_DETECT() throws IOException {
        ...
        proxy.initModules();
        assertEquals(DETECT, proxy.runDetect(3));

        ctest.disableTest();
    }

    @Test
    public void run_detect_Not_Exist_Xpose_Files_NOT_DETECT() throws IOException {
        Ctest ctest = new Ctest();
        ctest.enableTest();
        ...
        DetectModuleProxy proxy = new DetectModuleProxy();
        proxy.initModules();
        assertEquals(NOT_DETECT, proxy.runDetect(3));
